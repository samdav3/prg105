...
count = score = float(input('Test score: '))
while score > -1:
    print('Enter the next test score or -1 to end.')
    count = score = float(input('Test score: '))
    total += total + score
print(f'The total of the test scores is %{total}.')
count = count + score
...
while number <= 1 or number >= 10:
    print('ERROR: The number cannot be less than 2 or greater than 9.')
    number = int(input('Enter a number:  '))
    if 1 < number < 10:
        print('SUCCESS! You have entered a valid number!')
